 ...
 */
public abstract class AbstractPathVariableArgumentResolver extends AbstractNameAndValueArgumentResolverFactory {
     ...
     */
    private String cleanTemplateValueIfNecessary(String templateVariable) {
