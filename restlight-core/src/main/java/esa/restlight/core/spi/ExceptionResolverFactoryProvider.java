...
/**
 * Produces an instance of {@link ExceptionResolverFactory} which will be used to create {@link
 * esa.restlight.core.resolver.ExceptionResolver} for every handler.
 */
@SPI
