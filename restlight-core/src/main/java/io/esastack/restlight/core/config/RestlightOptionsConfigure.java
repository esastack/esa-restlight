...
public final class RestlightOptionsConfigure
        extends AbstractRestlightOptionsConfigure<RestlightOptionsConfigure, RestlightOptions> {
    ...
    @Override
    protected RestlightOptions newOptions() {
