...
public class ExceptionHandlerExecution extends SingletonExecutionHandler<HandlerMethodAdapter<HandlerMethod>> {

    private final Throwable th;

    public ExceptionHandlerExecution(DeployContext<? extends RestlightOptions> deployContext,
                                     HandlerMethodAdapter<HandlerMethod> handlerMethod,
                                     HandlerValueResolver handlerResolver,
                                     Handler handler,
                                     Throwable th) {
        super(deployContext, handlerMethod, handlerResolver, handler);
        this.th = th;
    }
