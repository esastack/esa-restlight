...
import io.esastack.restlight.core.context.impl.ByteBufHttpInputStream;
...
public class MockHttpRequest implements HttpRequest {
    ...
    public Set<Cookie> cookies() {
        if (cookies == null) {
            ...
            if (value == null) {
                ...
                Set<io.netty.handler.codec.http.cookie.Cookie> underlying = ServerCookieDecoder
                        .STRICT.decode(value);
    ...
    public static final class Builder {
        ...
        public Builder withCookie(Cookie cookie) {
            ...
            if (pre == null) {
                this.headers.set(HttpHeaderNames.COOKIE, cookie.encode(true));
            } else {
                this.headers.set(HttpHeaderNames.COOKIE, pre + ";" + cookie.encode(true));
            }
            return this;
        }
