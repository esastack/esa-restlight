...
public class ResponseEntityChannelImpl implements ResponseEntityChannel {
    ...
    protected static final AttributeKey<ResponseEntityChannel> RESPONSE_ENTITY_CHANNEL =
            AttributeKey.valueOf("$response.entity.channel");

    private final Response response;
    private HttpOutputStream outputStream;

    protected ResponseEntityChannelImpl(RequestContext context) {
        Checks.checkNotNull(context, "context");
        this.response = Checks.checkNotNull(context.attr(RequestContextImpl.UNDERLYING_RESPONSE).get(),
                "response");
        context.attr(RESPONSE_ENTITY_CHANNEL).set(this);
    }
