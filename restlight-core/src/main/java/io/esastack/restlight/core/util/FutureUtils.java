...
public final class FutureUtils {
    ...
    public static Class<?> retrieveFirstGenericTypeOfFutureReturnType(Method method) {
        return retrieveFirstGenericTypeOfFutureReturnType(method.getReturnType(), method.getGenericReturnType());
    }

    public static Class<?> retrieveFirstGenericTypeOfFutureReturnType(Class<?> type, Type genericType) {
        if (CompletableFuture.class.isAssignableFrom(type)
            ...
            return ClassUtils.retrieveFirstGenericType(genericType).orElse(Object.class);
        }
        return null;
    }
