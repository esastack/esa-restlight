...
class HandlerMappingImplTest {
    ...
    @Test
    void testProps() {
        final Mapping m = mock(Mapping.class);
        final RouteHandler r = mock(RouteHandler.class);
        final HandlerMapping mapping = new HandlerMappingImpl(m, r);
        assertEquals(m, mapping.mapping());
        assertEquals(r, mapping.handler());
    }
