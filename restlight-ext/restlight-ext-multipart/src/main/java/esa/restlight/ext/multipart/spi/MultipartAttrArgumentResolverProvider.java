...
import esa.restlight.ext.multipart.resolver.MultipartAttrArgumentResolver;

import java.util.Optional;

public class MultipartAttrArgumentResolverProvider extends AbstractMultipartParamResolverProvider {
