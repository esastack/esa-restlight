...
public class ValidationTest extends BaseIntegrationTest {
    ...
    public void testParam() throws Exception {
        RestResponseBase responseBase = restClient.get(domain + "/validation/param").addParam("name", "test")
        ...
        responseBase = restClient.get(domain + "/validation/param").execute().toCompletableFuture().get();
