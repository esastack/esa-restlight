...
public class SecurityContextParamResolver implements ParamResolverFactory {
    ...
    private static class SecurityContextResolver implements ParamResolver<ParamResolverContext> {

        @Override
        public Object resolve(ParamResolverContext context) throws Exception {
            return JaxrsContextUtils.getSecurityContext(context.requestContext());
        }
    }
}
