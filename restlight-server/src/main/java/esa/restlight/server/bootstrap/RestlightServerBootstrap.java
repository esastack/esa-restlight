...
public class RestlightServerBootstrap {
    ...
    public static RestlightServerBootstrap from(RestlightHandler handler) {
        return from(handler, ServerOptionsConfigure.defaultOpts());
    }

    public static RestlightServerBootstrap from(RestlightHandler handler, ServerOptions options) {
    ...
    public RestlightServerBootstrap withFilters(Collection<? extends Filter> filters) {
