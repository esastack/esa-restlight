...
public class RouteOptions implements Serializable {
    ...
    /**
     * cache ratio in {@link esa.restlight.server.route.impl.CachedRouteRegistry}
     * @deprecated unused
     */
    @Deprecated
    ...
    /**
     * compute rate ration in {@link esa.restlight.server.route.impl.CachedRouteRegistry}
     */
