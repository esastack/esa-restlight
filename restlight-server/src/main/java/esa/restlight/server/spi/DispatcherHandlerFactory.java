...
/**
 * DispatcherHandlerFactory is used to produce an instance of {@link DispatcherHandler} which services requests
 * transferred from http server side.
...
public interface DispatcherHandlerFactory {
    ...
    /**
     * Produces an instance of {@link DispatcherHandler}.
     *
     * @param ctx deploy context
     *
     * @return handler
     */
    DispatcherHandler dispatcherHandler(ServerDeployContext<? extends ServerOptions> ctx);
