...
public interface RestlightServerAware extends Aware {
    ...
    /**
     * Sets the {@link RestlightServer} that is running in current {@link esa.restlight.spring.Restlight4Spring}.
     *
     * @param server server started by {@link esa.restlight.spring.Restlight4Spring}
     */
