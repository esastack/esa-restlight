...
public interface ExtensionLocator {
    ...
    /**
     * Gets the class type of Extension. It means the class annotated by given annotation adviceType is a
     * extension class If it returns a class which is assignable from {@link Annotation}.
     *
